...
const { aggToFindCompleteUserById, aggToFindCompleteUserByEmail, aggFetchUsers } = require("./aggregation");
...
const getAllUsersS = async (managebleRoles) => {
  try {
    const users = await Users.aggregate(aggFetchUsers(managebleRoles));
